					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestione Autorizzazione RGS e SOA",
									"targetURL": "#rgssoa-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"rgssoa-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rgssoa",
									"url": sap.ui.require.toUrl("rgssoa")
								}
							}
						}
					}
