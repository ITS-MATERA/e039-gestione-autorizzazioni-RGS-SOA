sap.ui.define(
  ...
  function (BaseSoaController, formatter, JSONModel, MessageBox) {
    ...
    return BaseSoaController.extend(
      "rgssoa.controller.soa.detail.scenery.Scenario2",
      {
        formatter: formatter,
        ...
        onInit: function () {
          var self = this;
          var oModelUtility = {
            ViewId: "rgssoa.view.soa.detail.scenery.Scenario2",
          };
        ...
        _onObjectMatched: function (oEvent) {
          ...
          self.createModelUtilityDet(bDetailFromFunction, bRemoveFunctionButtons, "soa.detail.scenery.Scenario2");
